...
{
    /// <summary>
    /// Medium gallery grid item. Renders the image directly via OnRender with rounded corners.
    /// </summary>
    public class SamsungGridViewMedium : FrameworkElement
    {
        public static readonly DependencyProperty ImageSourceProperty =
            DependencyProperty.Register(nameof(ImageSource), typeof(ImageSource), typeof(SamsungGridViewMedium),
        ...
        protected override Size MeasureOverride(Size availableSize)
        {
            ...
            double height = double.IsInfinity(availableSize.Height) ? 150 : availableSize.Height;
            return new Size(width, System.Math.Max(height, 150));
        }
